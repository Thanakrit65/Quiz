...
def extract_pokemon_data(stat_info,name_info):
...
def main():
    request_id = input("Enter pokemon ID : ") #get id of pokemon
    url_stats = "https://pokeapi.co/api/v2/pokemon/"+  request_id
    pokemon_stats = make_pokeapi_request(url_stats) #use this url to get stats
    url_name = "https://pokeapi.co/api/v2/pokemon-form/"+  request_id
    pokemon_name = make_pokeapi_request(url_name) #use this url to get name and sprites
